...
In the second case, the last station's delivery is wide, so the third station is the one that Sonic really has to run to get to. It's $3$ miles away and he needs to get there within $2$ seconds, so he'll run at a speed of $3/2 = 1.5$ miles per second.
